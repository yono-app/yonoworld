...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE_URL}/logo.jpeg`, width: 1200, height: 630, alt: SITE_NAME }],
  },
  twitter: {
